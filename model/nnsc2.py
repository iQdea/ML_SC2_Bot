...
def check_data():
    choices = {"attack_closest_to_nexus": attack_closest_to_nexus,
...
for i in range(hm_epochs):
    ...
    while not_maximum:
        ...
        train_data = attack_closest_to_nexus + attack_enemy_structures + attack_enemy_start
        ...
        model.save("modelfile/BasicCNN-{}-epochs-{}-LR-STAGE1".format(hm_epochs, learning_rate))
        current += increment
        if current > maximum:
            not_maximum = False